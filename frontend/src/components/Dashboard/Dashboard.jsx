...
const Dashboard = () => {
  ...
  const pacientesAtendidosPorDia = (dia) => {
    return turnosSemana.filter((turno) => obtenerDiaSemana(turno.date) === dia)
      .length;
  };
    ...
    <div className="containerDashboard">
      <div className="containerWelcomeDashboard">
        <div className="welcomeDashboard">
          ...
          <div>
            <img
              src="https://stg.fundacionsantafedebogota.com/sites/default/files/styles/large/public/2022-10/dr-home.png?itok=j0px4kRI"
              alt=""
            />
          </div>
        </div>
